...
PYBIND11_MODULE(fasttext_pybind, m) {
  py::class_<fasttext::Args>(m, "args")
      ...
      .def_readwrite("pos_weights_str", &fasttext::Args::pos_weights_str)
      .def_readwrite("ct_classes_str", &fasttext::Args::ct_classes_str)
      .def_readwrite("gamma", &fasttext::Args::gamma)
      .def_readwrite("alpha", &fasttext::Args::alpha)
      .def_readwrite("beta", &fasttext::Args::beta)
      .def_readwrite("mu", &fasttext::Args::mu)
      .def_readwrite("lambda", &fasttext::Args::lambda)
